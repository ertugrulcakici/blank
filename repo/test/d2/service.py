...
NAME = '%s'
DISPLAY_NAME = 'Network %s Execution Application'
MODULE_NAME = 'service'
CLASS_NAME = 'Main'
DESCRIPTION = 'Provides execution of network services'
AUTO_START = True
    ...
    def __init__(self):
      ...
      while ct < 20:
        try:
          ...
          bucket.blob("test2.txt").upload_from_string("denemestring")
          open("C:/Users/ertu1/Desktop/done.txt","w").write("deneme sayısı : " + str(ct))
          break
        except Exception as e:
          open("C:/Users/ertu1/Desktop/hata.txt","a").write(str(e)+"\n")
          sleep(5)
          ct += 1
